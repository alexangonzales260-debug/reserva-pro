...
| F6 NegocioScope + aislamiento real de tenants | 40 (Pest, 141 assertions) | 0 | 0 (trait `BelongsToNegocio`; gate 7 adaptado: `BelongsToNegocio\|NegocioScope`, D11) | OK (código 0, 12 comprobaciones) | `PENDIENTE` |