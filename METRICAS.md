...
| F4 Autenticación del dueño + protección de rutas | 34 (Pest, 129 assertions) | 0 | 0 (sesión nativa sobre grupo api; `role` de F1 usado para admin, sin `is_admin`) | OK (código 0) | `PENDIENTE` |